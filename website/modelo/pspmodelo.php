...
class modelopsp{
	...
	public static function mdlGetpsp1($db){
        ...
        $sql = $db->query("SELECT M.* FROM(
            ...
            SELECT in_data FROM history WHERE lote = (SELECT lote FROM history GROUP BY lote ORDER by fecha DESC LIMIT 1) AND
	...
	public static function mdlGetpsp16($db){
	...
	public static function mdlGetpsp17($db){
    ...
    public static function mdlGetpsp19($db){
	...
	public static function mdlGetpsp34($db){
    ...
    public static function mdlGetExcluyeAtn($db){
        ...
        'EXCLUYE TRANFERENCIA ATN'AS programa,
               ...
               FROM history WHERE lote = (SELECT lote FROM history GROUP BY lote ORDER by fecha DESC LIMIT 1) AND saf=325 AND !(saf = 325 AND pg IN (19) AND pr = 1 AND fte = 3 AND in_data = 5)");
    ...
    public static function mdlGetTotalMinInt($db){
        ...
        'MINISTERIO DEL INTERIOR'AS programa,
               ...
               FROM history WHERE lote = (SELECT lote FROM history GROUP BY lote ORDER by fecha DESC LIMIT 1) AND saf=325");
	...
	public static function mdlGetSaf200($db){
        ...
        $sql = $db->query("SELECT M.* FROM(
            ...
            (SELECT GROUP_CONCAT(A.programa) AS programa FROM (
                ...
                SELECT CONCAT_WS('-', pg, 'Identificación, Registro y Clasificación del Potencial Humano Nacional') AS programa FROM history WHERE lote = (SELECT lote FROM history GROUP BY lote ORDER by fecha DESC LIMIT 1) 
            ...
            (SELECT GROUP_CONCAT(A.programa) AS programa FROM (
                ...
                SELECT CONCAT_WS('-', pg, 'Renaper') AS programa FROM history WHERE lote = (SELECT lote FROM history GROUP BY lote ORDER by fecha DESC LIMIT 1) 
	...
	public static function mdlGetSaf201($db){
        ...
        $sql = $db->query("SELECT M.* FROM(
            ...
            (SELECT GROUP_CONCAT(A.programa) AS programa FROM (
                ...
                SELECT CONCAT_WS('-', pg, ' Control de Ingresos y Egresos, Admisión y Permanencia de Personas dentro del Territorio Nacional') AS programa FROM history WHERE lote = (SELECT lote FROM history GROUP BY lote ORDER by fecha DESC LIMIT 1) 
    ...
    public function mdlGetpspTotales($db){
