<ul>
  ...
  <li>
    ...
    <ul class="nav submenu">
      <li><a href="importacion_eje.php">Ejecución presupuestaria</a> </li>
      <!-- <li><a href="importacion_ods.php">ODS 200 y 201</a> </li> -->
   </ul>
  </li>
  ...
  <li>
    ...
    <ul class="nav submenu">
      <li><a href="mascara_eje.php">Ejecución Jurisdicción</a> </li>
    </ul>
    <ul class="nav submenu">
      <li><a href="mascara_ac.php">Ejecución DINE </a> </li>
    </ul>
  </li>
