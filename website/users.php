          ...
          <?php endif;?>
           ...
           <td class="text-center">
             <div class="btn-group">
                ...
                <button type="button" class="btn btn-xs btn-danger" onclick="ejecucioneliminar(<?php echo (int)$a_user['id'];?>)" data-toggle="tooltip" title="Eliminar">
